...
enum ERROR_CODE
{
	...
	ERROR_CODE_GENERATE_SHAKE_HANDS_MSG_FAILED	= -19,		// 生成握手信息失败
	ERROR_CODE_SEND_SHAKE_HANDS_MSG_FAILED		= -20,		// 发送握手信息失败
	ERROR_CODE_WEBSOCKET_SHAKE_HANDS_FAILED		= -21,		// Websocket失败
	ERROR_CODE_TIME_WHEEL_RUN_OVER				= -22,		// 时间轮运行结束
	ERROR_CODE_MSG_HANDLE_FAIL					= -23		// 消息处理失败
};